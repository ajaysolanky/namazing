...
function ChatMockup() {
  return (
    <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl shadow-studio-forest/5">
      <div className="space-y-6">
        <div className="bg-studio-sand p-5 rounded-2xl rounded-tl-sm text-base text-studio-muted w-[85%] leading-relaxed">
          Do you have any sibling names we should consider to make sure the vibe matches perfectly?
        </div>
        <div className="bg-studio-forest p-5 rounded-2xl rounded-tr-sm text-base text-white w-[85%] ml-auto leading-relaxed shadow-md">
          Yes, we have a daughter named Clara. We like classic but not overly trendy.
        </div>
        <div className="bg-studio-sand p-5 rounded-2xl rounded-tl-sm text-base text-studio-muted w-[90%] leading-relaxed inline-flex gap-4 items-center">
